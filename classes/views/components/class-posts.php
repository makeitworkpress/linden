    ...
    public function populate() {
        ...
        foreach( $wp_query->posts as $post ) {
            $this->properties['posts'][$post->ID] = [ 
                ...
                'imageUrl'      => has_post_thumbnail($post) ? get_the_post_thumbnail_url( $post ) : false,
                'link'          => esc_url( get_permalink($post) ),   
                'meta'          => isset($this->atts['customize']['post_meta_disable']) && $this->atts['customize']['post_meta_disable'] ? false : new Meta(),
                'modified'      => get_the_modified_date('c', $post->ID ),        
                'more'          => isset($this->atts['customize']['post_archive_more']) && $this->atts['customize']['post_archive_more'] ? $this->atts['customize']['post_archive_more'] : '',
